      ...
      <div className="mx-auto flex h-16 w-full max-w-content items-center gap-3 px-4 md:h-20 md:px-8">
        ...
        <div className="ml-auto flex items-center gap-1">
          ...
          <a
            ...
            className="hidden min-h-11 min-w-11 items-center justify-center rounded-pill text-fg-muted transition-colors duration-150 hover:bg-bg-sunken hover:text-fg focus-ring sm:inline-flex"
          >
